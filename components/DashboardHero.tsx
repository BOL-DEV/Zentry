...
function DashboardHero() {
  return (
    <section className="flex lg:max-w-7xl mx-auto flex-row items-center lg:justify-between px-6 py-10 pt-24 bg-white text-slate-900 dark:bg-slate-950 dark:text-white dark:border-white/10">
        <div>
          <h1 className="lg:text-5xl text-4xl  font-bold tracking-tight">Dashboard</h1>
