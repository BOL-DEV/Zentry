          ...
          <div className="lg:col-span-7">
            <div className="space-y-5">
              ...
              <p className="text-base leading-relaxed text-slate-600 dark:text-slate-300">
                ...
                {" "}If you&apos;re attending, expect a well-structured schedule
                and a comfortable venue. If you&apos;re partnering, expect fast
                replies and clean deliverables.
              </p>

              <div className="grid gap-3 sm:grid-cols-2">
                {[
                  ["Curated lineups", "Speakers, sessions, and activities picked with intent."],
                  ["Smooth entry", "Check-in designed to keep lines moving."],
                  ["Clear updates", "Schedules, locations, and policies kept simple."],
                  ["Community-first", "Welcoming environments and respectful guidelines."],
                ].map(([title, copy]) => (
                  <div
                    key={title}
                    className="flex items-start gap-3 rounded-xl border border-purple-200/70 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-white/5"
                  >
...
export default OrganizerHomeClient;
