        ...
        <div className=" w-full pt-20 px-4 py-16">
            <div className="mx-auto flex w-full max-w-md flex-col items-center">
                <header className="mb-8 text-center flex flex-col gap-2">
                    <h1 className="text-3xl font-semibold tracking-tight text-slate-900 md:text-4xl dark:text-white">{role} Login</h1>
                    <p className="mt-2 text-md text-slate-600 dark:text-slate-300">Sign in to manage your events</p>
                </header>
                ...
                <div className="w-full rounded-2xl border border-purple-200/70 bg-white p-8 shadow-md md:p-8 dark:border-white/10 dark:bg-slate-950">
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            className="mt-2 h-12 w-full rounded-lg bg-purple-600 font-semibold text-white transition hover:bg-purple-700 focus:outline-none focus-visible:ring-4 focus-visible:ring-purple-600/30"
                        >
                            Sign In
                        </button>
                        ...
                        <div className="pt-2">
                            ...
                            <p className="text-center text-xs text-slate-600 dark:text-slate-300">Demo credentials (any email/password)</p>
                            <div className="mt-4 rounded-lg border border-purple-200/70 bg-purple-50 p-4 text-xs text-slate-600 dark:border-white/10 dark:bg-white/5 dark:text-slate-300">
                                <ul className="list-disc space-y-1 pl-4">
                                    <li>
                                        <span className="text-slate-900 dark:text-white">Email:</span> demo@example.com
                                    </li>
                                    <li>
                                        <span className="text-slate-900 dark:text-white">Password:</span> demo123
                                    </li>
                                </ul>
                            </div>
                        </div>
